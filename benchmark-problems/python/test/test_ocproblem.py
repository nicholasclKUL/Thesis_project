from nicholas_benchmark_problems.problems import QuadcopterProblem
from nicholas_benchmark_problems.formulations.ss import *
from nicholas_benchmark_problems.formulations.ms import *
...
def test_ocproblem():
    ...
    assert la.norm(ss_sol - ms_sol) < 1e-5
...
def test_ocproblem_soft():
    ...
    assert la.norm(ss_sol - ms_sol) < 1e-6
