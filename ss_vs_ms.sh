...
hpp_file="/home/nicholas/Thesis_project/problems/multi-RTAC.hpp"
...
do
    ...
    cpp_file="/home/nicholas/Thesis_project/applications/tests_ss_vs_ms.cpp"
    ...
    for i in {2..4}
    do
        cd /home/nicholas/Thesis_project/problems
