...
#define CASADI_GIT_REVISION "e5d6977d621e3b7a0cd0b2e24cdd2b73a6c3a8fe"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.3.0-318.e5d6977d6"  // NOLINT(whitespace/line_length)
...
#define CASADI_COMPILER_FLAGS " -fPIC -fvisibility=hidden -fvisibility-inlines-hidden    -DUSE_CXX11 -DHAVE_MKSTEMPS -DWITH_DEEPBIND -DCASADI_VERSION=31 -D_USE_MATH_DEFINES -D_SCL_SECURE_NO_WARNINGS -DWITH_DL -DWITH_DEPRECATED_FEATURES"  // NOLINT(whitespace/line_length)
