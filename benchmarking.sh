...
export KOKKOS_TOOLS_LIBS="${HOME}/kokkos-tools/profiling/simple-kernel-timer/kp_kernel_timer.so"
...
do
    ...
    cpp_file="${HOME}/Thesis_project/applications/tests_benchmarking.cpp"
