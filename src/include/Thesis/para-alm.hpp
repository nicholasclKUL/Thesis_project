...
class ParaALMSolver {
  public:
    ...
    using Params      = ParaALMParams<config_t>;
    ...
    struct Stats {
        ...
        /// @ref ParaALMParams::Σ_0_lower and that the initial tolerance was
        /// increased by @ref ParaALMParams::ε_0_increase because the inner solver
        ...
        /// @ref ParaALMParams::Σ_0 or @ref ParaALMParams::σ_0 or increasing the initial
        /// tolerance @ref ParaALMParams::ε_0 (or both).
        unsigned initial_penalty_reduced = 0;
        /// The number of times that the penalty update factor @ref ParaALMParams::Δ
        /// was reduced, that the tolerance update factor @ref ParaALMParams::ρ was
        ...
        /// penalty update factor @ref ParaALMParams::Δ or increasing the tolerance
...
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaALMParams, DefaultConfig);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaALMParams, EigenConfigf);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaALMParams, EigenConfigd);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaALMParams, EigenConfigl);
#ifdef ALPAQA_WITH_QUAD_PRECISION
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaALMParams, EigenConfigq);
#endif
