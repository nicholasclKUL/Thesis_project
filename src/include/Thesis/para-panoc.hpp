...
struct ParaPANOCProgressInfo {
    ...
    const ParaPANOCParams<config_t> &params;
};
...
class ParaPANOCSolver {
  public:
    ...
    using Params       = ParaPANOCParams<config_t>;
    using Direction    = DirectionT;
    using Stats        = ParaPANOCStats<config_t>;
    using ProgressInfo = ParaPANOCProgressInfo<config_t>;
...
struct InnerStatsAccumulator<ParaPANOCStats<Conf>> {
    USING_ALPAQA_CONFIG(Conf);
...
template <Config Conf>
InnerStatsAccumulator<ParaPANOCStats<Conf>> &
operator+=(InnerStatsAccumulator<ParaPANOCStats<Conf>> &acc,
           const ParaPANOCStats<Conf> &s) {
...
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCParams, DefaultConfig);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCParams, EigenConfigf);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCParams, EigenConfigd);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCParams, EigenConfigl);
#ifdef ALPAQA_WITH_QUAD_PRECISION
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCParams, EigenConfigq);
#endif
 
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCStats, DefaultConfig);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCStats, EigenConfigf);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCStats, EigenConfigd);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCStats, EigenConfigl);
#ifdef ALPAQA_WITH_QUAD_PRECISION
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCStats, EigenConfigq);
#endif
 
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCProgressInfo, DefaultConfig);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCProgressInfo, EigenConfigf);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCProgressInfo, EigenConfigd);
ALPAQA_EXPORT_EXTERN_TEMPLATE(struct, ParaPANOCProgressInfo, EigenConfigl);
#ifdef ALPAQA_WITH_QUAD_PRECISION
